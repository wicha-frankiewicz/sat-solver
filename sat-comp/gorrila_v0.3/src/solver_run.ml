...
(*      out_str ("next_line:"^next_line^":\n"); 
      out_str ("next_line: solver_sat_str:"^solver_params.solver_sat_str^":\n"); 
      out_str ("next_line: solver_unsat_str:"^solver_params.solver_unsat_str^":\n"); 
*)
